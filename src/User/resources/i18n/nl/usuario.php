...
return [
    ...
    'Unable to delete user. Please, try again later.' => 'Kan de gebruiker niet verwijderen. Probeer later opnieuw.',
    'Unable to disable Two factor authentication.' => 'Kan de 2 traps authenticatie niet uitschakelen.',
    'Unable to remove authorization item.' => 'Kan het authorisatie item niet verwijderen.',
    ...
    'A message has been sent to your email address. ' => 'Er is een bericht naar je e-mailadres verstuurd',
    'Awesome, almost there. ' => 'Awesome! We zijn er bijna.',
    'Class \'{0}\' does not exist' => '@@@@',
    'Disable Two-Factor Auth' => 'Twee-factor-authenticatie uitschakelen',
    'Enable Two-factor auth' => 'Twee-factor-authenticatie inschakelen',
    'I aggree processing of my personal data and the use of cookies
            to facilitate the operation of this site. For more information read our {privacyPolicy}' => 'Ik ga akkoord met het gebruik van cookies en het gebruik van mijn persoonlijke gegevens om de werking van deze site mogelijk te maken. Lees ook onze {privacyPolicy}',
    'I aggree processing of my personal data and the use of cookies to facilitate the operation of this site. For more information read our {privacyPolicy}' => 'Ik ga akkoord met het gebruik van cookies en het gebruik van mijn persoonlijke gegevens om de werking van deze site mogelijk te maken. Lees ook onze {privacyPolicy}',
    'Invalid two-factor code' => 'Ongeldige code',
    'Last login' => 'Laatst ingelogd op',
    'Registration ip' => 'Registratie IP-adres',
    'Rule class can not be instantiated' => '@@@@',
    'Rule class must extend \'yii\rbac\Rule\'' => '@@@@',
    'This will disable two-factor auth. Are you sure?' => 'Hiermee zet je twee-factor-authenticatie uit. Weet je het zeker?',
    'Two Factor Authentication' => 'Twee-factor-authenticatie',
    'Two factor successfully enabled.' => 'Twee-factor-authenticatie ingeschakeld.',
    'Two-Factor Authentication' => 'Twee-factor-authenticatie',
    'Two-factor auth protects you against stolen credentials' => 'Twee-factor-authenticatie beschermt je tegen gestolen wachtwoorden',
    'Two-factor authentication code' => 'Twee-factor-authenticatie code',
    'Two-factor authorization has been disabled.' => 'Twee-factor-authenticatie is uitgeschakeld',
    'Two-factor code' => 'Twee-factor-authenticatie code',
